...
export default function Banner() {
  return (
    // Reverted to your original padding and gap values
    <section className="w-full py-[70px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start justify-between gap-[45px]">
        {/* Text Section (with typo fix and keeping original responsive text) */}
        <div className="w-full md:w-1/2 lg:w-[70%] text-center md:text-left">
          ...
          {/* Corrected typo "texy" to "text" */}
          <p className="text-[16px] lg:text-[16px] md:text-[13px] sm:text-[14px] text-gray-600 leading-relaxed max-w-full mx-auto md:mx-0">
        ...
        {/* --- FIX IS APPLIED HERE --- */}
        {/* Image Section - Explicit height is added to this container */}
        <div className="w-full md:w-1/2 flex items-center justify-center md:justify-end gap-4 h-[280px] pe-[1%] md:pe-[2%] lg:pe-[1.5%]">
          <div className="flex flex-col gap-4">
            {/* These images stay exactly as you had them */}
            <Image
          ...
          {/* This container also stays the same */}
          <div className="relative w-[240px] h-[240px]">
            {/* All your original positioning classes are preserved */}
